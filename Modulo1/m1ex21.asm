...
ORDENA:
    ...
    JHS     INICIO_LOOP ; JOGA PARA O LOOP
...
INICIO_LOOP:
    ...
    JHS     COMPARACAO_LOOP    ; VAI PARA A IRECAO DE ORDENACAO
...
COMPARACAO_LOOP:
    ...
    JHS     CONTINUA_LOOP       ; VAI PARA A COMPARACAO
    ; REDUZ O VALOR DE R13
    DEC     R13
    JMP    INICIO_LOOP         ; VOLTA PARA O INICIO PARA PROXIMA ITERACAO
    NOP
...
CONTINUA_LOOP:
    ...
    CMP     R6,  0(R7)            ; VERIFICA SE O TERMO SEGUINTE<ANTERIOR
    JHS      COMPARACAO_LOOP    ; VOLTA PARA O INICIO SE ESTA CORRETA A ORDENACAO
